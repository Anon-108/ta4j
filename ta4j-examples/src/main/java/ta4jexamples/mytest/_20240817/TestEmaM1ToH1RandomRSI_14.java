...
public class TestEmaM1ToH1RandomRSI_14 {
...
//        }
        String fileName = "D:\\Program Files\\Code\\Hengxinchuang\\ta4j\\ta4j-examples\\src\\main\\resources\\Excel\\randomEmaTest\\RandomEmaTestRsi_14.xlsx";
        EasyExcel.write(fileName, OrderRecord.class).sheet("数据表").doWrite(orderRecords);
...
//        Rule exitShortRule = new OverIndicatorRule(closeLine, openLine).and(upIndicatorRule);
        ...
        RSIIndicator rsi = new RSIIndicator(new ClosePriceIndicator(myBackTest), 14);
